            ...
            messages.forEach(async message => {
                if (message.author.id === client.user.id && message.content.includes('friendly reminder')) {
                    ...
                    if (found) {
                        ...
                        promoChan.send({
                            content: `:warning: Link embed previews can be purchased in <#1049791650060324954>. You earn tokens by chatting and being active in the server. Posts sent in <#856719763187302441> don't earn tokens :warning:
