            ...
            case 'delete': {
                ...
                if (threadOwner) {
                    await threadOwner.send({
                        content: `Your <#1145561195861000252> thread has been deleted as it did not follow the channel guidelines. Please make sure you read the guidelines before creating a new thread`
                    }).catch(async () => {
