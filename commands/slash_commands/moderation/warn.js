...
**Reason:** ${reason}`)
                    .setFooter({ text: `Warning Added • ${warnId}`, iconURL: './res/images/warning_add_icon.png' })
                    .setTimestamp();
...
\`\`\`${reason}\`\`\``
                ...
                if (results.length >= 1) {
                    ...
                    for (const data of results) {
                        ...
                        let log = new EmbedBuilder()
                            ...
                            .setDescription(`**Member:** ${username} *(${userId})*`)
                            .setFooter({ text: `Warning Removed • ${warnId}`, iconURL: './res/images/warning_remove_icon.png' })
                            .setTimestamp();
            ...
            case 'list': {
                ...
                let warningEmbed = new EmbedBuilder()
                    ...
                    .setFooter({ text: `Warning`, iconURL: './res/images/warning_remove_icon.png' })
                    .setTimestamp()
